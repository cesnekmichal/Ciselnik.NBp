 ...
 * @author Michal
 */
public class KalkulatorTeplickeMetodyDialog extends UniDialog {

    private final TeplickaZaznam editovanyZaznam = new TeplickaZaznam();
    
    /**
     * Creates new form KalkulatorKlasickeMetodyDialog
     */
    public KalkulatorTeplickeMetodyDialog(java.awt.Window parent) {
        super(parent);
        initComponents();
                
        setTitle("Kalkulátor Teplické metody");
        ...
        setListeners(field_Oddenkove00,field_Oddenkove0,field_Oddenkove1,
                     field_Oddenkove2,field_Oddenkove3,field_Oddenkove4,
                     field_Ostatni00,field_Ostatni0,field_Ostatni1,
                     field_Ostatni2,field_Ostatni3,field_Ostatni4);
